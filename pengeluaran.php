    ...
    if (empty($nim) || empty($nama) || empty($tanggal_pengeluaran) || empty($saldo_pengeluaran) || empty($bukti_transaksi)) {
        ...
        if (mysqli_num_rows($qCheckNim) == 0) {
            ...
            if (isset($_GET['op']) && $_GET['op'] == 'edit') {
                $sql1 = "UPDATE transaksi_mahasiswa SET Nim='$nim', Nama='$nama', Tanggal_Pemasukan='$tanggal_pemasukan', Saldo_Pemasukan='$saldo_pemasukan', Tanggal_Pengeluaran='$tanggal_pengeluaran', Saldo_Pengeluaran='$saldo_pengeluaran', Bukti_Transaksi='$bukti_transaksi' WHERE id='$id'";
            } else {

                $sql1 = "INSERT INTO transaksi_mahasiswa(Nim, Nama, Tanggal_Pemasukan, Saldo_Pemasukan, Tanggal_Pengeluaran, Saldo_Pengeluaran, Bukti_Transaksi) 
                VALUES ('$nim', '$nama', '$tanggal_pemasukan', '$saldo_pemasukan', '$tanggal_pengeluaran', '$saldo_pengeluaran', '$bukti_transaksi')";
            }
